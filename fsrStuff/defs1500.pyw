...
class DetailLine(object):
    def __init__(self, num, TestPrint=False):
        ...
        self.From       = fldDef(0, line2)
        self.To         = fldDef(9, line2)
        self.POS        = fldDef(19,line2)
        self.TOS        = fldDef(80,line2, inUse=False) # not used on new form
        self.Code       = fldDef(25,line2)
        self.Mods       = fldDef(32,line2)
        self.Diags      = fldDef(44,line2)
        self.Charge     = fldDef(49,line2)
        self.Units      = fldDef(58,line2)
        self.EPSDT      = fldDef(62,line2)
        self.EMG        = fldDef(22,line2)
        self.COB        = fldDef(80,line2, inUse=False) # not used on new form
        self.LegacyID   = fldDef(67,line1)
        self.LegacyQual = fldDef(65,line1)
        self.NPI        = fldDef(67,line2)
        self.Note       = fldDef(0, line1)
        if TestPrint:
...
class Form1500(object):
    def __init__(self, TestPrint=False):
        """
